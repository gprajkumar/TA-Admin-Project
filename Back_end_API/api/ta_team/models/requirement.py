...
from .models import Client, EndClient, Account, AccountManager, HiringManager, Role_Type, Employee, JobStatus
class Requirements(models.Model):
    ...
    assigned_recruiter = models.ForeignKey(
        Employee, on_delete=models.CASCADE, related_name='assigned_recruiter', null=True, blank=True
    )
    assigned_sourcer = models.ForeignKey(
        Employee, on_delete=models.CASCADE, related_name='assigned_sourcer', null=True, blank=True
    )
